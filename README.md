...
Objetivos 
Este es un proyecto educativo que ofrece la posibilidad de practicar python y familiarizarse con Git y GitHub.

Niveles de Implementación
El proyecto consiste de varios niveles de implementación y la dificultad va incrementando de manera progresiva en cada nivel.
A continuación se enumeran todos los niveles:
-nivel esencial
-nivel medio
-nivel avanzado
-nivel experto

En esta fase del proyecto solamente se cubrirá el nivel esencial que se detalla a continuación
